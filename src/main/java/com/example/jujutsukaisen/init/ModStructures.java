...
import com.example.jujutsukaisen.world.structure.structures.DojoStructure;
...
public class ModStructures
{
     ...
     */
    public static final RegistryObject<Structure<NoFeatureConfig>> DOJO = DEFERRED_REGISTRY_STRUCTURE.register("dojo", DojoStructure::new);
    ...
    public static void setupStructures() {
        ...
        setupMapSpacingAndLand(
                DOJO.get(), /* The instance of the structure */
