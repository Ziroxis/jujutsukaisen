package com.example.jujutsukaisen.world.structure.configured;

import com.example.jujutsukaisen.Main;
import com.example.jujutsukaisen.init.ModStructures;
...
public class ConfiguredStructures
{
     ...
     */
    public static StructureFeature<?, ?> CONFIGURED_DOJO = ModStructures.DOJO.get().configured(IFeatureConfig.NONE);
    ...
    public static void registerConfiguredStructures() {
        ...
        Registry.register(registry, new ResourceLocation(Main.MODID, "dojo"), CONFIGURED_DOJO);
         ...
         */
        FlatGenerationSettings.STRUCTURE_FEATURES.put(ModStructures.DOJO.get(), CONFIGURED_DOJO);
