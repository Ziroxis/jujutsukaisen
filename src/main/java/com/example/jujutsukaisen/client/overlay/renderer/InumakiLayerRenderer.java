...
public class InumakiLayerRenderer<T extends LivingEntity, M extends EntityModel<T>> extends LayerRenderer<T, M> {

    private static final ResourceLocation resourceLocation =
            new ResourceLocation("jujutsukaisen:textures/overlay/inumaki_overlay.png");

    private InumakiLayerModel model = new InumakiLayerModel();

    public InumakiLayerRenderer(IEntityRenderer<T, M> entityRendererIn) {
    ...
    public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn,
        ...
        String clan = statsProps.getClan();

        if (clan.equals(ModValues.Inumaki))
        {
