...
public class DisasterTidesTailRenderer<T extends LivingEntity, M extends EntityModel<T>> extends LayerRenderer<T, M> {

    private static final ResourceLocation resourceLocation =
            new ResourceLocation("jujutsukaisen:textures/overlay/disaster_tides_overlay.png");

    private DisasterTidesTailModel model = new DisasterTidesTailModel();

    public DisasterTidesTailRenderer(IEntityRenderer<T, M> entityRendererIn) {
    ...
    public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn,
        ...
        if (statsProps.getCurse().equals(ModValues.WATER))
        {
