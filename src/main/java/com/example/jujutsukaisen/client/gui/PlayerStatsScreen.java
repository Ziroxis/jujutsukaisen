...
public class PlayerStatsScreen extends Screen {
    ...
    public void backgroundRendering(MatrixStack matrixStack)
    {
        ...
        String level = Integer.toString(props.getLevel());
        String maxExperience = Integer.toString(props.getMaxExperience());
        String experience = Integer.toString(props.getExperience());
        ...
        drawString(matrixStack, font, "ADVENTURER CARD", guiLeft + 82, guiTop + 30, Color.GRAY.getRGB());
        ...
        drawString(matrixStack, font, "Level: " + level, guiLeft + 5, guiTop + 80, 16777215);
        drawString(matrixStack, font, "Experience: " + experience + "/" + maxExperience, guiLeft + 5, guiTop + 95, 16777215);
